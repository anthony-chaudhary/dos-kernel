...
Run:  python examples/residual_review/residual_review.py origin/master..HEAD
      python examples/residual_review/residual_review.py --json HEAD~20..HEAD
      python examples/residual_review/residual_review.py            # default range
"""
...
# config. We ship a generic default so the example runs standalone.
