# How AI built langchain-ai/langchain

> **Every one of the 29 AI commits here that made a checkable claim did what it said — each claim backed by the commit's own diff.**
...
AI agents wrote **0%** of the last 10,000 commits here — 39 agent-authored
commits. The agents behind them: **copilot 24 · claude 15**.

Of those, **29** made a concrete claim you can check ("fix X", "add tests
...
| | |
|---|---|
| Audited range | `6826feea147ce7761f9d27fe0fe7c3566e19ed95` → `62f255980d3fcb6fe24f2471498b4fdad289319b` |
| Commits in range | 39 (39 attributed commits audited) |
| Rendered | 2026-06-15 |
...
|---|---|---|---|---|---|---|
| 39 | 29 | 29 | 0 | 10 | 0.0% | **0 of 29 (0.0%)** |

## By kind of claim

| Kind of claim | Backed by the diff | Claimed, not shown | Skipped |
|---|---|---|---|
| `fix / add / remove` (code) | 20 | 0 | 0 |
| `docs` | 9 | 0 | 0 |
| no checkable claim (skipped) | — | — | 10 |
...
git checkout 62f255980d3fcb6fe24f2471498b4fdad289319b
pip install dos-kernel
dos commit-audit --sweep --json --workspace . \
    6826feea147ce7761f9d27fe0fe7c3566e19ed95..62f255980d3fcb6fe24f2471498b4fdad289319b
```
