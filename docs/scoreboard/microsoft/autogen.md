# How AI built microsoft/autogen

> **Every one of the 27 AI commits here that made a checkable claim did what it said — each claim backed by the commit's own diff.**
...
AI agents wrote **1%** of the last 3,782 commits here — 30 agent-authored
commits. The agents behind them: **copilot 28 · claude 2**.

Of those, **27** made a concrete claim you can check ("fix X", "add tests
...
| | |
|---|---|
| Audited range | `492990655d09a144d99e91de4dedda761a70302e` → `027ecf0a379bcc1d09956d46d12d44a3ad9cee14` |
| Commits in range | 30 (30 attributed commits audited) |
| Rendered | 2026-06-15 |
...
git checkout 027ecf0a379bcc1d09956d46d12d44a3ad9cee14
pip install dos-kernel
dos commit-audit --sweep --json --workspace . \
    492990655d09a144d99e91de4dedda761a70302e..027ecf0a379bcc1d09956d46d12d44a3ad9cee14
```
