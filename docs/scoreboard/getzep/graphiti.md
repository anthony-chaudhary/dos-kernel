# How AI built getzep/graphiti

> **Every one of the 66 AI commits here that made a checkable claim did what it said — each claim backed by the commit's own diff.**
...
AI agents wrote **15%** of the last 874 commits here — 127 agent-authored
commits. The agent behind them: **claude 127**.

Of those, **66** made a concrete claim you can check ("fix X", "add tests
...
| | |
|---|---|
| Audited range | `1de840dc948929b611ab13ac65223cfb2eb4ea1c` → `0ed90b72505c2a6a4f3ee953939888fb56572944` |
| Commits in range | 127 (127 attributed commits audited) |
| Rendered | 2026-06-15 |
...
```bash
git clone https://github.com/getzep/graphiti.git && cd graphiti
git checkout 0ed90b72505c2a6a4f3ee953939888fb56572944
pip install dos-kernel
dos commit-audit --sweep --json --workspace . \
    1de840dc948929b611ab13ac65223cfb2eb4ea1c..0ed90b72505c2a6a4f3ee953939888fb56572944
```
