# How AI built agno-agi/agno

> **Every one of the 103 AI commits here that made a checkable claim did what it said — each claim backed by the commit's own diff.**
...
AI agents wrote **3%** of the last 5,697 commits here — 168 agent-authored
commits. The agents behind them: **claude 159 · copilot 7 · aider 1 · devin
1**.

Of those, **103** made a concrete claim you can check ("fix X", "add tests
...
| | |
|---|---|
| Audited range | `792c6ed9428a296b3fa0b62c628e1acc648187c9` → `5cf1ed7f943ff78a2ed0c3c5c14a3bc7fb689e85` |
| Commits in range | 168 (168 attributed commits audited) |
| Rendered | 2026-06-15 |
...
|---|---|---|---|---|---|---|
| 168 | 103 | 103 | 0 | 65 | 0.0% | **0 of 103 (0.0%)** |

## By kind of claim

| Kind of claim | Backed by the diff | Claimed, not shown | Skipped |
|---|---|---|---|
| `fix / add / remove` (code) | 95 | 0 | 0 |
| `tests` | 2 | 0 | 0 |
| `docs` | 6 | 0 | 0 |
| no checkable claim (skipped) | — | — | 65 |
...
git checkout 5cf1ed7f943ff78a2ed0c3c5c14a3bc7fb689e85
pip install dos-kernel
dos commit-audit --sweep --json --workspace . \
    792c6ed9428a296b3fa0b62c628e1acc648187c9..5cf1ed7f943ff78a2ed0c3c5c14a3bc7fb689e85
```
